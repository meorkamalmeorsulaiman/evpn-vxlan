...
2. leaf03 will learn the H18 mac address and add into it mac table. Since the VLAN is part of the VNI, it will sent an update too via BGP to it peers. Finally, the switch will encapsulate the ARP request and flood it in the entire fabric with the following details:
...
## Unicast Traffic - ARP Reply

The ARP has reached the destination. Now let see how the reply look like.

![Lab ARP Rep](https://github.com/meorkamalmeorsulaiman/evpn-vxlan/blob/ndfc-9/images/ndfc/0-lab-arp-rep.png)